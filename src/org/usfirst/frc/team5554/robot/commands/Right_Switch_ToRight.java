...
//    	addParallel(new TimedMechSys(RobotMap.FEEDERAXISKEY, 0.25,2));
    	addSequential(new MechDistanceGyroDrive(0.0023, 0.000029, 0.02,  RobotMap.PERCENTTOLERANCE, 315, RobotMap.FORWARDENCODER, false, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward,5));
...
//    	addSequential(new MechDistanceGyroDrive(0.006, 0.00002,0,  RobotMap.PERCENTTOLERANCE, 65 /*97*/, RobotMap.FORWARDENCODER, false, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward, 3));

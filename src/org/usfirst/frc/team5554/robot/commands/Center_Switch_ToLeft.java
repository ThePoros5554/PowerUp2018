...
public class Center_Switch_ToLeft extends CommandGroup {
    ...
    {    	
		...
		addSequential(new MechDistanceGyroDrive(0.035, 0.0000, 0.1,  5, -150, RobotMap.SIDEENCODER, 0, RobotMap.SIDEGYROKP, MechDrivingDirection.Sideways));
		...
		addSequential(new MechDistanceGyroDrive(0.0035, 0.000035, 0.015,  5, 150, RobotMap.FORWARDENCODER,0, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward, 2.5));
...
//    	addSequential(new TimedMechSys(RobotMap.FEEDERKEY, 0.5,0.3));
//    	addSequential(new MechDistanceGyroDrive(0.003, 0.000035, 0.007,  5, 130, RobotMap.FORWARDENCODER,false, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward));
//    	addSequential(new TimedMechSys(RobotMap.FEEDERKEY, 0.5,0.3));

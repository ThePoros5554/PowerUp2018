...
//    	addSequential(new MechDistanceGyroDrive(0.09, 0.0000, 0.1,  5, -140, RobotMap.SIDEENCODER, RobotMap.FORWARDENCODER, RobotMap.FIXGYROKP, 0, RobotMap.FORWARDGYROKP, MechDrivingDirection.Sideways));
...
//////////////////////////////909090909090909090909090909//////////////////////////////    	
    	...
    	addSequential(new MechDistanceGyroDrive(0.003, 0.000042, 0.007,  5, 150, RobotMap.FORWARDENCODER,false, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward, 3));
    	addSequential(new TimedMechSys(RobotMap.FEEDERKEY, 0.5,0.3));

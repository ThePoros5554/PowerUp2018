...
//addSequential(new MechDistanceGyroDrive(0.0035, 0.000042, 0.007,  5, 105, RobotMap.FORWARDENCODER, false, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward,4));
//addSequential(new Timeout(0.1));
//addSequential(new MechDistanceGyroDrive(0.04, 0.0000, 0.1,  5, 140, RobotMap.SIDEENCODER, 0, RobotMap.SIDEGYROKP, MechDrivingDirection.Sideways));
//addSequential(new TimedMechSys(RobotMap.FEEDERKEY, 0.5,0.3));
//addSequential(new TimedMechSys(RobotMap.ELEVATORKEY, -0.6, RobotMap.ELEVATORSTAYUPSPEED,1.5));
//addSequential(new Timeout(0.2));
//addSequential(new MechDistanceGyroDrive(0.0035, 0.00004, 0.025,  5, 160 /*220cm*/, RobotMap.FORWARDENCODER,0, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward, 3));
...
//addSequential(new MechDistanceGyroDrive(0.0035, 0.000035, 0.007,  5, 130 /*193cm*/, RobotMap.FORWARDENCODER, false, RobotMap.FORWARDGYROKP, MechDrivingDirection.Forward));

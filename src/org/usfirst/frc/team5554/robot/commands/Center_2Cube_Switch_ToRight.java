...
public class Center_2Cube_Switch_ToRight extends CommandGroup {
    ...
    { 
    	...
    	addSequential(new MechDistanceGyroDrive(0.11, 0.0000, 0.1,  5, 107.5, RobotMap.SIDEENCODER, RobotMap.FORWARDENCODER, RobotMap.FIXGYROKP, 0, RobotMap.FORWARDGYROKP, MechDrivingDirection.Sideways));
